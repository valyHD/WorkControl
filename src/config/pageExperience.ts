...
const PAGE_EXPERIENCES: PageExperienceDefinition[] = [
  ...
  { id: "users-new", pathPattern: "/users/new", title: "Utilizator nou", section: "Echipa", description: "Creeaza un cont nou.", breadcrumbs: [{ label: "Utilizatori", path: "/users" }, { label: "Utilizator nou" }], requiredRole: ["admin"] },
